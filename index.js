...
async function getWeather() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            setWidgetBackground(data.weather[0].description.toLowerCase());
...
function setWidgetBackground(condition) {
    const weatherWidget = document.getElementById('weatherWidget');
    weatherWidget.classList.remove('clear', 'clouds', 'sunny');

    // Add the corresponding background class based on condition
